  ...
  return (
    <div className="w-[360px] min-h-screen bg-white flex flex-col">
      ...
      <div className="flex items-center justify-center px-4 py-3 relative">
        ...
        <div className={language === 'TH' ? 'text-xl font-anuphan font-extrabold text-[#7E4300]' : 'text-xl font-tiroTamil text-[#7E4300]'}>{t.booking}</div>
      </div>
      ...
      {loading ? (
        <div className="flex-1 flex items-center justify-center">
          <div className={language === 'TH' ? 'text-[#7E4300] text-lg font-anuphan font-extrabold' : 'text-[#7E4300] text-lg font-tiroTamil'}>{t.loading}</div>
        </div>
      ) : (
        <div className="flex-1 px-4 py-4 space-y-4">
        {/* Select Branch */}
        <div>
          <label className={language === 'TH' ? 'block text-base font-anuphan font-extrabold text-[#000000] text-left mb-1' : 'block text-base font-tiroTamil text-[#000000] text-left mb-1'}>
          ...
          <div className="relative">
            <div 
              ...
              className={`w-full px-3 py-1 bg-[#E7E7E7] border border-[#818181] rounded-3xl ${language === 'TH' ? 'font-anuphan font-extrabold' : 'font-tiroTamil'} text-base focus:outline-none cursor-pointer text-left ${
            ...
            {dropdownOpen === 'branch' && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-[#E7E7E7] border border-[#818181] rounded-2xl shadow-lg z-10">
                <div
                  ...
                  className={language === 'TH' ? 'px-3 py-2 font-anuphan font-extrabold text-[#999999] text-base cursor-pointer rounded-full mx-2 my-1 text-left hover:bg-red-100 hover:text-red-600 italic' : 'px-3 py-2 font-tiroTamil text-[#999999] text-base cursor-pointer rounded-full mx-2 my-1 text-left hover:bg-red-100 hover:text-red-600 italic'}
                >
                  {t.clear}
                </div>
                {branchOptions.map((option) => (
                  <div
                    ...
                    className={`px-3 py-2 ${language === 'TH' ? 'font-anuphan font-extrabold' : 'font-tiroTamil'} text-[#000000] text-base cursor-pointer rounded-full mx-2 my-1 text-left ${
          ...
          <div className="flex justify-start">
            <div className="relative inline-block">
              <input 
                ...
                className={`w-40 px-3 py-1 bg-[#E7E7E7] border border-[#818181] rounded-full ${language === 'TH' ? 'font-anuphan font-extrabold' : 'font-tiroTamil'} text-[#000000] text-base focus:outline-none focus:ring-2 focus:ring-[#8B4513]`}
        ...
        <div>
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full px-3 py-1 bg-[#E7E7E7] border border-[#818181] rounded-full ${language === 'TH' ? 'font-anuphan font-extrabold' : 'font-tiroTamil'} text-[#000000] text-base focus:outline-none focus:ring-2 focus:ring-[#8B4513]`}
        ...
        <div className="pt-4 flex justify-center">
          <button 
            className={language === 'TH' ? 'mt-2 !bg-[#DCA900] text-white text-xs font-anuphan font-extrabold self-center cursor-pointer py-1 px-2 rounded border-none hover:scale-110 hover:opacity-80 transition-all disabled:opacity-50 disabled:cursor-not-allowed' : 'mt-2 !bg-[#DCA900] text-white text-xs font-tiroTamil self-center cursor-pointer py-1 px-2 rounded border-none hover:scale-110 hover:opacity-80 transition-all disabled:opacity-50 disabled:cursor-not-allowed'}
            disabled={submitting}
            onClick={async () => {
              try {
