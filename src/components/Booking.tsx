    ...
    <div className="m-0 w-[360px] min-h-[90vh] bg-white flex flex-col items-center justify-start px-4 pt-2 pb-4">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-white bg-opacity-80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-8 mx-4 max-w-sm w-full shadow-2xl border-2 border-[#6B4423] transform scale-105">
            <div className="text-center">
              ...
              <div className="flex gap-4 justify-center">
                <button
                  ...
                  className="px-6 py-3 bg-gray-100 text-[#6B4423] rounded-xl hover:bg-gray-200 transition-all font-tiroTamil font-medium border border-gray-300"
                >
                  No, Keep It
                </button>
                <button
                  ...
                  className="px-6 py-3 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all disabled:opacity-50 font-tiroTamil font-medium shadow-lg"
                >
