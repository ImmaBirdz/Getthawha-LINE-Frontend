...
function Header() {
    ...
    return (
        <div className="m-0 w-[360px] h-fit bg-[linear-gradient(90deg,#4C2B00_0%,#2D1406_100%)] flex flex-col relative">
            ...
            {/* Header */}
            <div className="p-2">
                <div className="text-[30px] text-[#DEC33A] font-artifika">{t.headerTitle}</div>
                <div className="text-[20px] text-[#B9A43B] relative bottom-2 font-arya">{t.headerSubtitle}</div>
            </div>
        </div>
    );
}
